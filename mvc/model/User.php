...
class User {
    ...
    public function addCredito($val_credito)
    {
    	if (!filter_var($val_credito, FILTER_VALIDATE_REGEXP, array('options' => array('regexp' => '/[0-9]/')))) {
    		return false;
    	}
    	$this->credito += $val_credito;
    	return true;
    }
    ...
    public function setNegozio($val_negozio)
    {
    	$this->negozio = $val_negozio;
    }
